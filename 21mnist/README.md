...
platforms; the compiler chooses the corresponding code to compile automatically. I worked on this during
my attendance of the lecture "Parallel and Distributed Programming" by Prof. Kenjiro Taura.

What follows below is the description of the project by Prof. Taura.
